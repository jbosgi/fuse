...
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.ACL_PROVIDER;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.CONNECTION_TIMEOUT;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.DEFAULT_CONNECTION_TIMEOUT_MS;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.DEFAULT_MAX_SLEEP_MS;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.DEFAULT_SESSION_TIMEOUT_MS;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.ENSEMBLE_ID;
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.MAX_RETRIES_LIMIT;
...
import static org.fusesource.fabric.zookeeper.internal.curator.Constants.SESSION_TIMEOUT;
...
import static org.fusesource.fabric.zookeeper.internal.curator.TrackerUtils.closeQuietly;


public class ManagedCuratorFramework implements ManagedService, Closeable {

    private static final Logger LOGGER = LoggerFactory.getLogger(org.fusesource.fabric.zookeeper.internal.curator.ManagedCuratorFramework.class);
    ...
    public void updated(Dictionary properties) throws ConfigurationException {
        if (isRestartRequired(oldProperties, properties)) {
            ...
            if (!propertyEquals(oldProperties, properties, ENSEMBLE_ID)) {
                curatorFramework.reset();
            }
        }
